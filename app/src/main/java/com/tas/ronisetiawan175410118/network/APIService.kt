package com.tas.ronisetiawan175410118.network
...
interface InfoService{
    ...
    fun getInfoService(@Url url: String?): Call<List<InfoCountry>> //Pada constructor metode, dibuatkan variabel dengan                                                           //anotasi @Url untuk directory dinamisnya
}